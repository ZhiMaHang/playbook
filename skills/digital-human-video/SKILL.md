...
| 位置 | 音乐应低于人声 | 含义 |
|---|---|---|
| 人声停顿处 | **8~12 dB** | 听得见,有氛围 |
| 人声最响处 | **16~20 dB** | 不抢话 |

低于人声 20 dB 以上 = 手机上根本听不见,等于白加(2026-08-04 第一版 `volume=0.07`
就是这个毛病:闪避后低 24.6 dB,加了个寂寞)。低于 5 dB = 音乐跟人抢。

验证方法:把音乐支路单独渲出来与人声逐秒比对。**不要拿"混音后 vs 原音轨"去测闪避**——
音乐在总和里占比很小,压不压都测不出差别,会误判成"侧链没工作"。
